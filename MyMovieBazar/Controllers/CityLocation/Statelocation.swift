...
class Statelocation: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
          ...
          arrayTitle = ["andhrapradeh Asam","Bihar","Uttarpradesh","Madhyapradesh"]
          registerNibs()
  }
     ...
     func registerNibs() {
        ...
        let searchTextField =  UITextField(frame: CGRect(x: 20, y: UnderLine.frame.maxY+5, width: screenWidth-40, height: 40))
           searchTextField.placeholder = "Search for your State"
...
extension Statelocation: UITextFieldDelegate {
