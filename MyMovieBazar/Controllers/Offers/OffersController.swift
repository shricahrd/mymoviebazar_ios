...
class OffersController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       if let cell = tableView.dequeueReusableCell(withIdentifier:"OffersCell", for: indexPath as IndexPath) as? OffersCell {
           //cell.contentView.backgroundColor = .clear
           cell.promocode.text = arrayTitle[indexPath.row]
           cell.promocode.font = UIFont.boldSystemFont(ofSize: 14)
