...
class MyAdsController:   UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @objc func showConsultationFlow() {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier:"MyAccountCell", for: indexPath as IndexPath) as? MyAccountCell {
            ...
            cell.radioButton.setImage(UIImage(named: "unselectedradio.png"), for: .normal)
            return cell
        }
