...
class TechniciansVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
 ...
 func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
     ...
     lbltitle.frame = CGRect(x: 0, y: imageProduct.frame.maxY+2, width: viewBG.frame.size.width, height: 30)
//     title.text = self.arrayCategory[indexPath.row]
 ...
 func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
    ...
    @IBAction func clikedLocation(_ sender: Any) {
    }
    @IBAction func clikedAdd(_ sender: Any) {
    }
    @IBAction func clikedNotification(_ sender: Any) {
     }
